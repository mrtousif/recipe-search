    ...
    const markup = `
        ...
        <div class="recipe__ingredients">
            <ul class="recipe__ingredient-list">
                ${recipe.ingredients.map(listRecipeItem).join('')}
            </ul>
...
export const updateServingsIngredientsQty = (recipe) => {
    // update the serving
    document.querySelector('.recipe__info-data--people').textContent = recipe.servings
    // update quantity of ingredients
    const allRecipeCount = Array.from(document.querySelectorAll('.recipe__count'))
    allRecipeCount.forEach((element, index) => {
